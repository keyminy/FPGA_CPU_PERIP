...
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { GPOA[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { GPOA[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { GPOA[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { GPOA[3]  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { GPOA[4]  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { GPOA[5]  }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { GPOA[6]  }]; #IO_25_14                     ,Sch=LED6
set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS33 } [get_ports { GPOA[7]  }]; #IO_L24N_T3_A00_D16_14        ,Sch=LED7
...
# set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { btn_clear }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
...
# set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { btn_change }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND
...
# set_property -dict { PACKAGE_PIN K17  IOSTANDARD LVCMOS33 } [get_ports { echo }]; #IO_L12N_T1_MRCC_14 ,Sch=JC1
# set_property -dict { PACKAGE_PIN M18  IOSTANDARD LVCMOS33 } [get_ports { trigger }]; #IO_L11P_T1_SRCC_14 ,Sch=JC2
